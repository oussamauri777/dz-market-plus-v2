                        ...
                        {session ? (
                            <div className="flex items-center gap-3 pl-3 border-l border-gray-200 ml-3">
                                {session.user?.role === 'admin' && (
                                    <Link
                                        href="/admin"
                                        className="inline-flex items-center px-4 py-2 border border-primary text-sm font-bold rounded-full text-primary hover:bg-primary hover:text-white transition-all gap-2"
                                    >
